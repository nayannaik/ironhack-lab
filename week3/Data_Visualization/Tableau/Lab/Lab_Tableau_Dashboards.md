...
- top 3 most profitable "corpor3 most profitable productate" customers. (Hint: check the option "add to context" on filters. This option tells Tableau that the "contextual" filter should be applied before any other filter).
- top  sub categories in every region.
